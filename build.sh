...
CMD="$CMD -CMAKE_EXPORT_COMPILE_COMMANDS=${CMAKE_EXPORT_COMPILE_COMMANDS}"
...
LLVM_BUILD_EXAMPLES=${LLVM_BUILD_EXAMPLES:-On}
...
CMD="$CMD -BUILD_SHARED_LIBS=${BUILD_SHARED_LIBS}"

BUILD_SHARED_LIBS=${BUILD_SHARED_LIBS:-On}
CMD="$CMD -BUILD_SHARED_LIBS=${BUILD_SHARED_LIBS}"

LLDB_EXPORT_ALL_SYMBOLS=${LLDB_EXPORT_ALL_SYMBOLS:-1}
CMD="$CMD -LLDB_EXPORT_ALL_SYMBOLS=${LLDB_EXPORT_ALL_SYMBOLS}"
